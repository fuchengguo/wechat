			...
			<div class="weui_search_bar" _v-c7cde232="">
					<form class="weui_search_outer">
						<div class="weui_search_inner"> 
							...
							<input type="search" class="0.5s" placeholder="搜索">
				...
				<ul class="wechat-list" _v-c7cde232="">
					<li v-for="a in arr"class="item _line-fine chat-item-transition" _v-c7cde232="">
						<div class="info" _v-c7cde232="" style="touch-action: pan-y; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							<div class="ico-box" _v-c7cde232=""> <i _v-c7cde232="" class="_news-count">{{a.new_count}}</i>
								<div class="ico" _v-c7cde232=""> <img alt="pic" _v-c7cde232="" :src="a.src"> </div>
							</div>
							<div class="desc" _v-c7cde232="">
								<a :href="a.href" @click="mit(a.id)" >
									<div class="desc-time" _v-c7cde232="">{{a.time}}</div>
									<div class="desc-title" _v-c7cde232="">{{a.name}}</div>
									<div class="desc-message" _v-c7cde232="">
										<div class="desc-mute iconfont icon-mute" _v-c7cde232="" title="false" v-show="a.quite"></div> <span _v-c7cde232="" title="friends">{{a.friends}}</span> <span _v-c7cde232="">{{a.talk}}</span> </div>
								</a>
							</div>
						</div>
		...
		data() {
			return {
				arr:[{
					...
					href:"#/dialog/0",
					new_count:1,
					src:"//ad-gold-cdn.xitu.io/14999138688354f1720f589d2d33db77f026bb07c8f67.jpg",
					name:"猪猪侠",
					time:"16:24",
					friends:"猪猪侠:",
					talk:"今晚去去唱歌？",
					...
					href:"#/dialog/1",
					new_count:10,
					src:"//ad-gold-cdn.xitu.io/1499913766441c45960d8bd44ed5ffcf0d4a67d0aa317.jpg",
					name:"猪猪侠群",
					time:"16:24",
					friends:"",
					talk:"来呀快活呀，反正有大把时间！！",
					...
					href:"#/dialog/2",
					new_count:11,
					src:"//ad-gold-cdn.xitu.io/14999139497307c668d55b4dd5984b6accc6bf41206a8.jpg",
					name:"稀土圈",
					time:"16:24",
					friends:"",
					talk:"挖掘最优质的互联网技术",
					...
					href:"#/dialog/3",
					new_count:"",
					src:"//tb1.bdstatic.com/tb/cms/ngmis/file_1453447545023.jpg",
					name:"饿了么",
					time:"16:24",
					friends:"",
					talk:"饿了么网上订餐平台",
...
//		},
		methods:{
			mit:function(a){
			console.log(this);
		    this.$store.state.a.name = this.arr[a].name;
		    this.$store.state.a.clear = this.arr[a].quite;
		    this.$store.state.a.count = this.arr[a].count;
